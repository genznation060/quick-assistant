...
class CustomSession(context: Context) : VoiceInteractionSession(context) {
    ...
    private fun showInteractiveOverlay() {
        val root = FrameLayout(context).apply {
            setBackgroundColor(Color.parseColor("#33000000")) // Subtle translucent overlay
        }
        ...
        // Floating Action Pill (Copy & Google icons)
        val popupPill = LinearLayout(context).apply {
            ...
            // Pill background: Rounded white card with drop shadow
        ...
        root.setOnTouchListener { _, event ->
            if (event.action == MotionEvent.ACTION_DOWN) {
                ...
                if (hit != null) {
                    ...
                    targetX = targetX.coerceIn(20, (context.resources.displayMetrics.widthPixels - pillWidth - 20))
